...
public class ReflectionsTestUtilsTest {
  @Autowired
  ...
  public void getPrivateField() {
    ...
    // you can get rid of getters/setters and this will work
  }
  ...
  public void invokePrivateMethod() {
    assertEquals("Ian 1",
      ...
      "Fail private method call");
  }

  @Test
  public void invokeStudentInfoPrivateMethod() {
    assertEquals("Ian McBee ian.mcbee@com",
      ReflectionTestUtils.invokeMethod(studentOne, "studentInformation"),
      "Fail private method call");
  }
}
